      ...
      if (window.__bnReadOnly) {
        ...
        if (msg) {
          msg.textContent = bnPreviewAsEmail
            ? ('👁️ Previewing as ' + bnPreviewAsEmail + ' — read-only. (Exit from Admin to return to your view.)')
            : "Read-only view — your role is restricted_view. You can browse but not modify.";
        }
      } else {
