...
// AND for admins previewing as another user (so the UI behaves identically in both cases).
function bnIsRestrictedView() {
  return (typeof bnUserPermission !== 'undefined' && bnUserPermission === 'restricted_view') ||
