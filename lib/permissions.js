...
async function bnAdminPreviewAs(email) {
  ...
  // Hop to Home — the previewed user wouldn't see Admin anyway. Use the standard
  // view-switch path so all the side effects (sidebar highlight, body classes,
  // visibility of admin nav, etc.) line up.
  try {
