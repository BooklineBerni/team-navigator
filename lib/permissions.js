    ...
    if (!pendingOnly.length) {
      ...
      allowEl.innerHTML = pendingOnly.map(row => {
        ...
        <div style="display:flex; align-items:center; gap:10px; padding:10px 14px; border-bottom:1px solid #f0f0f0;">
          ...
          <select data-bn-allow-perm="${escapeHtml(row.email)}" title="Permission applied when the user signs in" style="padding:6px 8px; border:1px solid #d0d0d0; border-radius:6px;">${opts}</select>
